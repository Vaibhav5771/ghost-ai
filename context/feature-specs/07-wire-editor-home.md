...
Create a hook in 'hooks/' that manages dialog state and project multations.

**Create**

- manage create dialog state 
- manage project name input
- generate a short unique suffic
- slugify the  name to create the room ID
- call 'POST/api/projects'
- navigate to the new workspace

The project IF and Liveblocks room ID  should stay aligned.
