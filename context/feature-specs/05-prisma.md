...
- 'canvasJsonPath' for future blob storage 
- timestamps
- indexes on onwer ID and creation date
...
- collaborator email
- creation timestamp
- unique constraint on project/eemail
...
Create 'lib/prisma.ts' as a chached singleton.
...
- schema has both models with the correct relations and indexes
- 'lib/prisma.ts' exports one cached Prisma instance
- migration runs successfullt
