...
Build the'/editor' home screen and the add project  dialogs/sidebar actions. No API calls or persistence yet.
...
Clicking 'New Projects' should open the Create Project dialog.
